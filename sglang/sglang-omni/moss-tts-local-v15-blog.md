...
Set `"stream": true`, `"response_format": "pcm"`, and `"stream_format": "audio"` to receive raw 48 kHz PCM chunks as they are produced. Pipe the stream through `ffmpeg` when you want a playable WAV file:
